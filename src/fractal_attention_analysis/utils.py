...
class DeviceManager:
    ...
    def get_device_config(self, model_size_params: int) -> Dict[str, Any]:
        ...
        if model_size_params > 500_000_000:
            ...
            config["max_memory"] = {0: f"{self.max_gpu_memory_gb}GB", "cpu": "32GB"}
...
class ModelLoader:
    ...
    def load_model(self, model_name: str, force_eager_attention: bool = True, **kwargs) -> tuple:
        ...
        model_kwargs = self._prepare_model_kwargs(model_name, force_eager_attention, **kwargs)
    ...
    def _prepare_model_kwargs(
        self, model_name: str, force_eager_attention: bool, **kwargs
    ) -> Dict[str, Any]:
