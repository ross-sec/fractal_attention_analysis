...
class FractalAttentionAnalyzer:
    ...
    def _fractal_analysis(self, attention_weights: np.ndarray) -> Dict[str, Any]:
        ...
        fractal_dimension = self.fractal_transforms.compute_fractal_dimension(
            attention_weights
        )
        ...
        golden_ratio_scored = self.fractal_transforms.golden_ratio_scoring(
            attention_weights
        )
        
        # Compute self-similarity
        self_similarity = self.fractal_transforms.compute_self_similarity(
            attention_weights
        )
