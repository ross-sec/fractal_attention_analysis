...
class TestAttentionMetrics:
    ...
    def test_interpretability_score(self):
        ...
        score = self.metrics.compute_interpretability_score(self.test_matrix, fractal_dimension=2.0)
    ...
    def test_compute_all_metrics(self):
        ...
        all_metrics = self.metrics.compute_all_metrics(self.test_matrix, fractal_dimension=2.0295)
